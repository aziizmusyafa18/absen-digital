...
ALTER TABLE guru ADD COLUMN foto VARCHAR(255) NULL DEFAULT NULL;

-- Tambah kolom foto ke tabel siswa
ALTER TABLE siswa ADD COLUMN foto VARCHAR(255) NULL DEFAULT NULL;

-- Tambah kolom foto ke tabel orang_tua
ALTER TABLE orang_tua ADD COLUMN foto VARCHAR(255) NULL DEFAULT NULL;
